...
namespace SerialPortListener.Serial
{
    ...
    public class SerialSettings : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Class constructor Loads Settings from default settings file
        /// </summary>
        ...
        /// <summary>
        /// How frequency to run the timer to send data to serial
        /// </summary>
        public int FrequencySend
        {
            get { return _FrequencySend; }
            set { _FrequencySend = value; }
        }
